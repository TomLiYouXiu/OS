...
public class Bank{
    ...
    int[] Available = {10, 8, 7};//剩余资源
    int[][] Max = new int[3][3];//进程所需资源
    int[][] Alloction = new int[3][3];//已有资源
    int[][] Need = new int[3][3];//所需资源
    int[][] Request = new int[3][3];//再次请求资源
    int[] Work = new int[3];//所剩工作资源
